                        ...
                        <form action="../netting/process.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="" name="yemek_baslik" required="required" placeholder="Yemek Adını Giriniz" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="form-control col-md-7 col-xs-12" name="yemek_aciklama" id="" cols="300" rows="10" placeholder="Yemek Açıklamasını Giriniz"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="" name="yemek_footer" placeholder="Yemek  Sloganı Giriniz" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="anasayfayemekkaydet" class="btn btn-success">Kaydet</button>
                                </div>
                            </div>
                    </div>
                    </form>
